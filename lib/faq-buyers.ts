...
export const buyerFaq: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "A buyer specialist helps you interpret listing details and market data, schedule showings (including guard-gated communities), draft competitive offers aligned with local norms, and stay aligned with your lender and title partner through closing.",
  },
  {
    question: "How do I search for homes for sale in Rhodes Ranch (89148)?",
    answer:
      "Use the on-site home search on this site to filter by price, beds, baths, and more. For a curated list that matches lifestyle goals—schools, commute, floor plan—ask for a private consult.",
  },
  {
