...
export const metadata: Metadata = {
  title: "Search Rhodes Ranch Area Homes for Sale | MLS Listings",
  description:
    "Browse MLS-powered listings with RealScout. For a curated Rhodes Ranch (89148) search, contact Dr. Jan Duffy, Berkshire Hathaway HomeServices Nevada Properties.",
    ...
    <main className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
      <header className="max-w-3xl">
        ...
        <p className="mt-4 text-lg leading-relaxed text-slate-700">
          ...
          {siteContact.agentName} for a Rhodes Ranch–focused search that matches budget, timing, and
          must-haves.
        </p>
